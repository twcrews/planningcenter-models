...
public record Group
{
  ...
  /// <summary>
  /// Calculated value. Either <c>true</c> or <c>false</c>.
  /// It will be <c>false</c> if any of these conditions are true:
  /// * The group is archived
  /// * The group is full (has reached specified enrollment limit)
  /// * Enrollment Strategy is <c>closed</c>
  /// * Enrollment deadline has passed
  /// </summary>
  [JsonApiName("enrollment_open")]
  public bool? EnrollmentOpen { get; init; }

  /// <summary>
  /// The enrollment strategy for the group.
  /// See <a href="https://pcogroups.zendesk.com/hc/en-us/articles/360016079154#Visibility&amp;EnrollmentStatus">documentation</a>
  /// for more information about group enrollment settings.
  /// 
  /// Possible values: <c>closed</c>, <c>request_to_join</c>, or <c>open_signup</c>
  /// </summary>
  [JsonApiName("enrollment_strategy")]
