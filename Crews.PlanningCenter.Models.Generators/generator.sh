...
HTTP_EXTENSIONS_VERSION="3.0.0"
HTTP_EXTENSIONS_FRAMEWORK="netstandard2.0"

PRIMITIVES_EXTENSIONS_VERSION="1.2.1"
PRIMITIVES_EXTENSIONS_FRAMEWORK="netstandard2.0"
...
t4 \
	...
	-r "$SCRIPT_DIR/../Crews.PlanningCenter.Models.Generators/bin/Debug/$GENERATOR_FRAMEWORK/Crews.PlanningCenter.Models.Generators.dll" \
